...
Original file is located at
    https://colab.research.google.com/drive/1eniQXYUx_YE61BGdLBNOdZIFIf3UjJO-
"""
...
def train(data_loader, X_test, y_test, net, optimizer, lr_scheduler, device, n_epochs=200, batch_size=64, seed=0):
    n_classes = 2
